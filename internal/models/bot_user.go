...
type BotUser struct {
	...
	HomeStation   datatypes.JSON `gorm:"type:jsonb" json:"home_station"`
	AwayStation   datatypes.JSON `gorm:"type:jsonb" json:"away_station"`
	MorningTime   string         `json:"morning_time"` // "07:00"
	EveningTime   string         `json:"evening_time"` // "17:30"
	WorkDays      datatypes.JSON `gorm:"type:jsonb" json:"work_days"` // ["mon","tue","wed","thu","fri"]
...
type OneTimeAlert struct {
	...
	Dest         datatypes.JSON `gorm:"type:jsonb" json:"dest"`
